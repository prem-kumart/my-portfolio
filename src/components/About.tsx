      ...
      >
        ...
        >
          ...
          >
            {infoList
              .slice(0, 2)
              .map(({ icon, iconDark, title, description }, index) => (
                <motion.li
                  whileHover={{ opacity: 1.5 }}
                  key={index}
                  className=" break-words overflow-hidden border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-white  hover:hover:bg-darkHover/50 "
                >
                  {mounted && (
                    <Image
                  ...
                  <h3 className="my-4 font-semibold text-gray-700 dark:text-white text-wrap">
                    {title}
                  </h3>
